...
ADMINS = (
    # ('Ramon Vianna', 'ramonwsv@gmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_PATH, 'poll_project_db.sqlite3'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'su=(@x)7k0+*!!s41yl61ro6fia+ps==y2bq_uuycjazymcedf'
